...
<head>
    ...
    <style>
        ...
        /* Dark mode overrides */
        [data-theme="dark"] .bg-color-option:hover,
        [data-theme="dark"] .image-position-option:hover,
        [data-theme="dark"] .text-alignment-option:hover {
            background: rgba(196, 147, 90, 0.08);
        }
        [data-theme="dark"] .bg-color-option.selected,
        [data-theme="dark"] .image-position-option.selected,
        [data-theme="dark"] .text-alignment-option.selected {
            background: rgba(196, 147, 90, 0.12);
        }
        [data-theme="dark"] .image-position-preview {
            background: #3D4250;
        }
    </style>
</head>
    ...
    <div class="admin-layout">
        ...
        <aside class="admin-sidebar" id="adminSidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="content.php?tab=general" class="nav-item <?= $isGeneralActive ? 'active' : '' ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <a href="content.php" class="nav-item <?= $isSectionsActive ? 'active' : '' ?>">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
