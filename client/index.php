...
<head>
  ...
  <?php $hotelName = getHotelName(); $logoText = getLogoText(); $contactInfo = getContactInfo(); $headerStyle = getSetting('header_style', 'classic'); ?>
...
<body data-header-style="<?= h($headerStyle ?? 'classic') ?>">
  <?php $currentPageSlug = ''; include __DIR__ . '/includes/header.php'; ?>
