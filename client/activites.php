...
<head>
  ...
  <title>À Découvrir | <?= h($hotelName) ?> - <?= h($logoText) ?></title>
...
<body data-i18n-title="activities.pageTitle" data-header-style="<?= h($headerStyle ?? 'classic') ?>">
  <?php $currentPageSlug = 'activites'; include __DIR__ . '/includes/header.php'; ?>
